...
/**
 * Toggle component renders an accessible checkbox-based toggle switch with an optional label.
 *
 * @param props - Toggle component props.
 * @param props.size - Size variant, default is "sm". Accepts "sm" or "md" and adjusts track/knob dimensions.
 * @param props.className - Additional class names applied to the underlying `input`.
 * @param props.label - Optional text label rendered next to the toggle.
 * @param props.disabled - If true, disables the input and applies disabled styling.
 * @param props.[other] - Other native input props forwarded to the checkbox input.
 * @returns A JSX element containing a label, hidden checkbox input, styled track, movable thumb, and optional label text.
 *
 * @remarks
 * Uses a `cn` helper (on line 20 and elsewhere) to conditionally combine className strings.
 */
